...
class CaptionGenerator(object):
    ...
    def _project_features(self, features):
        with tf.variable_scope('project_features', reuse=tf.AUTO_REUSE):
    ...
    def _selector(self, context, h, reuse=False):
        with tf.variable_scope('selector', reuse=tf.AUTO_REUSE):
    ...
    def build_sampler(self, max_len=20):
        ...
        alpha_list = []
        beta_list = []
        lstm_cell = tf.nn.rnn_cell.BasicLSTMCell(num_units=self.H, reuse=tf.AUTO_REUSE)
